  ...
  return (
    <header className={`sticky top-0 z-50 bg-primary-50 h-[90px] flex items-center py-4 justify-between gap-4 md:gap-8 ${
      ...
      <div className="flex items-center gap-2 md:gap-4">
        <LanguageSwitcher />
        {isProductsPage && (
          <button className="hidden sm:flex px-3 sm:px-4 py-2 bg-primary-100 text-white rounded-lg text-xs sm:text-sm font-medium hover:bg-primary-200 transition-colors items-center gap-1 sm:gap-2 whitespace-nowrap">
